      ...
      <div className="flex justify-between items-start mb-6 flex-none">
        <div>
          ...
          <div className="flex items-center gap-3">
            <span className="text-3xl font-semibold text-gray-900 dark:text-gray-100 tracking-tighter">
              {platformFilter === 'Aggregate' ? '350K' : platformFilter === Platform.TWITTER ? '215K' : '95K'}
            </span>
            <span className="text-emerald-500 text-[10px] font-semibold bg-emerald-500/10 px-2 py-0.5 rounded-md border border-emerald-500/20">+12.5%</span>
          </div>
        </div>
